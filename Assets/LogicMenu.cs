...
{ 
    ...
    public TextMeshProUGUI coinText,shuffleText,hintText, freezeText;
    ...
    public void GetData()
    {
        if (PlayerPrefs.GetInt(PlayerPrefsManager.isGetDefaultItems) == 0)
        {
            ...
            PlayerPrefs.SetInt(PlayerPrefsManager.freeze, 5);
        ...
        freezeText.text = PlayerPrefs.GetInt(PlayerPrefsManager.freeze).ToString();
    }
